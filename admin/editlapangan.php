            ...
            <div class="editlapangan">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="input-group">
                            <input type="text" name="panjang" value="<?php echo $row['panjang'] ?>" class="form-control" placeholder="Panjang"
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="harga" class="form-control" placeholder="Harga" aria-describedby="basic-addon2">
